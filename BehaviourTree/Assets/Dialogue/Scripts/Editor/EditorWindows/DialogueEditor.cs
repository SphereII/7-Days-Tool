...
namespace Dialogue.Scripts.Editor.EditorWindows
{
    public class DialogueEditor : EditorWindow
    {
        ...
        private ToolbarMenu _toolbarMenuHistory;
        ...
        private void ConfigureToolbar()
        {
            ...
            // var exportMenu = toolbar.Q<ToolbarMenu>("Export Manager");
            ...
            _toolbarMenuHistory = toolbar.Q<ToolbarMenu>("History");
            _toolbarMenuHistory.RegisterCallback<ClickEvent>(_ => ShowHistory());
        ...
        private void ShowHistory()
        {
            ...
            foreach (var dialog in cfg.GetHistory())
            {
                _toolbarMenuHistory.menu.AppendAction(dialog.name, _ => _graphView.PopulateView(dialog),
        ...
        {
            var wnd = GetWindow<ExportEditor>();
            wnd.titleContent = new GUIContent("Export Manager");
            wnd.ShowPopup();
        }
